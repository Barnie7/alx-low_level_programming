...
File 9-fizz_buzz .c is a program that prints the numbers from 1 to 100, followed by a new line, but for multiples of three print Fizz instead of the number and for the multiples of five print Buzz, and multiples of both three and five print FizzBuzz.
File 10-print_triangle is a function that prints a triangle, followed by a new line.
